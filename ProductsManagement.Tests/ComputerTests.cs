...
namespace ProductsManagement.Tests
{
    public class ComputerTests
    {
        ...
        public void SearchComputersByTheirName()
        {
            ...
            //arrange          
            repository.Setup(x => x.SearchComputersByComputerName("le"))
                .Returns(searchedComputer);
            var service = new ComputerService(repository.Object);

            //act
            var actionResult = service.SearchComputersByComputerName("le");

            //assert
            Assert.Equal(searchedComputer.ToString(), actionResult.ToString());
        }
        ...
        public void NotEqualSearchComputersByTheirName()
        {
            ...
            //arrange 
            repository.Setup(x => x.SearchComputersByComputerName("xdcasdas"))
                 .Returns(GetComputers);
            var service = new ComputerService(repository.Object);

            //act
            var actionResult = service.SearchComputersByComputerName("xdcasdas");
